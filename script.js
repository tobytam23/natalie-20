...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // ------------------------------ 隐藏信件与打字显示情书 ------------------------------
  const loveLetter = "親愛的豬豬 Natalie：恭喜人生達到二字頭啦！！首先要同我豬豬講聲生日快樂🎂學業進步 最重要嘅當然係身體健康（肉肉多多）！ 知道豬豬過去一年過得有啲辛苦所以上天派大豬豬來提供情緒價值比我細豬豬🐷豬豬係新嘅一年有咩唔開心要學識同大豬豬講！特別係晚黑一個人emo係床到偷偷喊嘅時候 只要細豬豬一唔開心 大豬豬就會即刻進入戰鬥警備狀態 安撫好豬豬係我最高優先級嘅任務！ 當然 都希望我豬豬新嘅一年可以開開心心🥰 少啲emo 但係大豬豬係你嘅後盾！希望我嘅禮物可以讓我豬豬係寒冷嘅冬天都會有豬豬嘅溫暖 個香水唔駛講 我真係爆計 我用左一個晏晝先搞點佢🥹 澳門賣斷貨了… 結果我豬豬係我買完之後就話想要… surprise都比唔到了 跟住個手套係知道我豬豬手凍到變凍豬手了 豬豬 我好愛你呀我嘅豬豬 生日快樂🎂";
  ...
  submitQuizBtn.addEventListener("click", () => {
    ...
    // 情况 1：满分
    if (score === 5) {
      quizImage.src = "images/b.jpg";   // 满分图
      quizMessage.textContent = "滿分！我豬豬好聰明呀 我之后要请猪猪饮三次奶茶！";
    ...
    quizMessage.textContent = "恭喜我猪猪获得呼哈呼哈卷啊哈哈哈哈"
    quizImage.hidden = false;
